    ...
    render: function () {
        if (this.state.state === 'going') {
            return React.createElement(
                ...
                React.createElement(
                    'div',
                    { className: this.state.fading ? "ebb_show" : "ebb_giveup" },
                    '☹'
                ),
                React.createElement(
                    'div',
                    { className: this.state.fading ? "ebb_fade" : "" },
            ...
            return React.createElement(
                ...
                React.createElement(
                    'div',
                    { className: 'ebb_num', onClick: function () {
                            this.start(1);
                        }.bind(this) },
                    React.createElement(
                        'span',
            ...
            return React.createElement(
                ...
                React.createElement(ContentEditable, { disabled: true, className: 'ebb', onChange: this.handleChange, html: this.state.html })
            );
        }
    }
});
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    ReactDOM.render(React.createElement(Main, null), content);
});

},{"react":159,"react-contenteditable":2,"react-dom":3}]},{},[160]);
